-- POPBY EXISTING PROJECT UPGRADE: OFFICIAL BGM TRACK LINKS
-- Run once after upgrade_mobile_map_card_refinement.sql. Safe to rerun.
-- Existing Thoughts stay readable; only newly published BGM links are checked.
